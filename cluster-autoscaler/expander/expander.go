...
var (
	...
	AvailableExpanders = []string{RandomExpanderName, MostPodsExpanderName, LeastWasteExpanderName, PriceBasedExpanderName, LifecycleExpanderName}
	...
	// special lifecycle group
	LifecycleExpanderName = "lifecycle"
)
